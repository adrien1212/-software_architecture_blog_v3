...
:::definition
To achieve its [business domain’s](./domain) goals and targets, a company has to operate in multiple subdomains. A subdomain is a fine-grained area of business activity.
:::
...
![3 types subdomain](./images/three_types_subdomain.png)
...
### Comparaison
![comparing subdomain](./images/comparing_types_subdomain.png)
