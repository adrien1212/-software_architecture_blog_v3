...
Aujourd’hui, de nombreux logiciels sont développés en suivant une approche Anemic Domain Model. Cela aboutit à un code difficile à comprendre et à maintenir, car :
...
- **Un domaine qui reflète le modèle relationnel BDD**
