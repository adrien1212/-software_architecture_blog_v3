...
Les deux concepts sont fortement liés. L’élasticité permet d’automatiser le mécanisme de [scalabilité](./scalability) des ressources informatique mise à disposition.
