...
En d'autre terme, et en s’appuyant sur la [loi de Conway](https://agile.adriencaubel.fr/agile/gestion_equipe_et_individus/conway_law) l'architecte doit prendre garde à l'organisation des équipes et des interactions pour que l'architecture imaginée soit implémentée.
