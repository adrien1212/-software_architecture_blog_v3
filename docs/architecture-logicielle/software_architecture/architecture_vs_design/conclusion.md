...
Il est compliqué de conclure simplement sur cette différence. Le plus important est de noter la **collaboration entre l'architecte logiciel et les développeurs** (voir [D'après Marc Richards](./mark_richards_definition))
...
- E.g. [styles architecturaux](../../architecture_style/), [caractérisitques architecturales](../../software_characteristics/), etc ...
