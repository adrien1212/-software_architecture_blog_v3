...
Nous devons mettre en œuvre le principe [Low Coupling, High Cohesion](../../couplage_and_cohesion/) :
- à la fois à l’intérieur (*intra*) de nos [modules](../../modularity/definition), en organisant nos classes, packages et les dépendances entre eux
- et aussi entre (*inter*) les [modules](../../modularity/definition), en minimisant les dépendances croisées et en favorisant des interfaces claires.
...
<div style={{display: 'flex', justifyContent: 'space-between'}}>
  <div style={{textAlign: 'center'}}>
    <img src="./images/poorly_boundaries.png" alt="Poorly Boundaries" width="65%" />
  </div>
  <div style={{textAlign: 'center'}}>
    <img src="./images/better_boundaries.png" alt="Better Boundaries" width="70%" />
  </div>
</div>
...
- Le [Bounded Context](../../bounded_context/) de chaque service doit être correctement défini
