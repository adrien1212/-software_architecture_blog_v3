...
Si nous reprenons l'exemple de l'architecture en couche, en plus de permettre [l'abstraction](./abstraction), cette architecture permet l'encapsulation des données. 
