...
:::warning
**Attention**, cela ne signifie pas qu'un module (e.g. une classe) ne doit faire qu'une seule chose. Le SRP nous dit que cette classe est responsable devant un seul acteur où autrement dit un seul acteur est demandeur du changement sur cette classe.
[Voir ma video 1:48](https://youtu.be/Awmnk62AjAY?t=108)
:::

## Exemple 1

Prenons l'exemple d'une classe (i.e un module) qui compile et imprime un rapport. Cette classe ne respecte pas le SRP :
...
Une classe respectant le SRP possède généralement une forte cohésion, car tous ses éléments contribuent à une responsabilité unique.

Et le non-respect du SRP conduit donc souvent à un couplage élevé.