...
- Le [couplage](../../couplage_and_cohesion/) : l'objectif est d'avoir des modules ayant un faible couplage entre eux
- La [cohésion](../../couplage_and_cohesion/) : les éléments regroupés au sein d'un même module doivent avoir une forte cohésion, ils couvrent les mêmes objectifs, la même fonctionnalité
