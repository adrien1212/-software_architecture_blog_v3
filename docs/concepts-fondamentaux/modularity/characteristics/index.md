...
Dans la section [Définition d'un module](../definition) nous avons abordé les caractéristiques théoriques d'un module. Ici grâce à l'article en ressource nous comprenons comment les mettre en œuvre.
...
![alt text](./images/victor.png)

![alt text](./images/victor2.png)
