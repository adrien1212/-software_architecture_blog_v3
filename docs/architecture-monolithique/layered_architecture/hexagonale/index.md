...
![Alt text](./images/hexa1.png)

## 2. Communication sortante (Driven Port)

:::note Note
If we want to follow the [Single Responsibility Principle](../../../concepts-fondamentaux/solid/single_responsibility), then we would have a lot of ports, _each one for a use case_.
:::
