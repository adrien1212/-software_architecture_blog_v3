...
Pour ce faire, nous devons reprendre les bases avec l'inversion de dépendance. En effet, dans la [partie 2](../../../concepts-fondamentaux/solid/dependency_inversion/dependency_Inversion_2) nous affirmions
