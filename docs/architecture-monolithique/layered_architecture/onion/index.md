...
Comme expliqué dans Se centrer sur le domaine nous cherchons à ne pas avoir de couplage entre le coeur applicatif et les applications tierces (e.g. BDD).
...
- Le [Domain Model](../../../ddd/implement_business_logic/domain_model/) qui représente les concepts métiers, leurs attributs et leurs comportements (Entités, Aggregates et Value Object)
- Le [Domain Service](../../../ddd/implement_business_logic/domain_service) quand de la logique métier ne dépend pas que d'une seule entité
- Et l’[Application Service](../../../ddd/implement_business_logic/application_service) qui sert d'interface entre le monde extérieur (e.g. BDD) et le domaine métier

=> Nous pouvons nous appuyez sur le DDD pour implémenter la coeur applicatif de notre application

### Communiquer avec l'extérieur
Puis pour communiquer avec l'extérieur, nous nous appuyons sur la notion d'Adapter
