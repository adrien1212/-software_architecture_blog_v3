...
Nous repartons de l'architecture Layered présentées. Elle permet d'avoir des couches logiques isolés.

![Layered](./images/layered-detailled.png)

### 2. Architecture Layered à l'extrême
Maintenant si on pousse le concept [d'inversion de dépendances](../../../concepts-fondamentaux/solid/dependency_inversion/)
